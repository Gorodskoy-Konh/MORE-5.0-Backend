"""The engine module - the engine module that provides the class working with asynchronous database.

Classes:     DatabaseEngine - class that provides the interface for the database management.

Notes:     The main feature of this module is simplification of working with     database engine and
sessions.
"""
...
class DatabaseEngine:
    ...
    Used to initialize async engine on creation, to define session_maker and provide an ability to
    open sessions when it is needed. Moreover, this class contains methods for starting and
    finalizing behavior.

    __engine(AsyncEngine):     The async engine instance __session_maker(async_sessionmaker):
    ...
    async def start(self) -> None:
        ...
        The method to create all the tables in the database. Usually, it is done on initialization
        of app stage.
        """
    ...
    async def session(self) -> AsyncGenerator[AsyncSession, None]:
        ...
        Yields:     session: async session generator
        """

...
* `assignment_id`: The ID of the assignment. * `assignment_date`: The date of the assignment. *
`courier_id`: The ID of the courier assigned to the assignment. * `orders`: A list of orders
assigned to the assignment. * `courier`: The courier assigned to the assignment.
"""
...
class AssignmentDB(Base):
    ...
    Attributes:     `assignment_id`: The ID of the assignment.     `assignment_date`: The date of
    the assignment.     `courier_id`: The ID of the courier assigned to the assignment.
    `orders`: A list of orders assigned to the assignment.     `courier`: The courier assigned to
    the assignment.
    """
